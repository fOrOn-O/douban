...
|---|---|---:|---:|---:|---:|---|---|
| requests/Selenium | `python main.py --requests` | 250 | 1065 | 81分16.35秒 | 100.0% | 适合完整采集 | 2026-05-16 23:09:59 |
| Scrapy | `python main.py --scrapy` | 0 | 0 | 2分49.82秒 | 失败 | 本次运行异常，请查看日志 | 2026-05-16 21:22:11 |
| 分析流程 | `python main.py --analysis` | 250 | 4071 | 1分40.66秒 | 100.0% | 情感缓存后更快 | 2026-05-16 23:11:44 |
